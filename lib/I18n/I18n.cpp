...
const char *const I18n::STRINGS_EN[] = {
    ...
    "Checking WiFi...", "Enter WiFi Password",
    ...
    // KOReader Sync
    "KOReader Sync", "No credentials configured", "Set up KOReader account in Settings",
    "Progress found!", "Remote:", "Local:", "Apply remote progress", "Upload local progress",
    "No remote progress found", "Upload current position?", "Progress uploaded!",
    "Sync failed", "Section", "Page", "From:",
    ...
    "Sleep Screen Cover Filter", "UI Theme", "Sunlight Fading Fix",
    "Book's Embedded Style", "Remap Front Buttons",
    // Additional Setting Values (v1.0 merge)
    "Cover + Custom", "Contrast",
    "Full w/ Percentage", "Full w/ Book Bar", "Book Bar Only", "Full w/ Chapter Bar",
    "Classic", "Lyra", "Book's Style",

    // Reader Menu (v1.0 merge)
    "Chapter", "Book", "pages",
    "Go to %", "Go Home", "Delete Book Cache",
    "Go to Position", "Left/Right: 1%  Up/Down: 10%",
    // KOReader Sync status messages
    "Syncing time...", "Calculating document hash...",
    "Failed to calculate document hash",
    "Fetching remote progress...", "Uploading progress...",

    // Calibre Connect UI
    "Connect to Calibre", "Use Calibre wireless device transfers",
    "Starting Calibre...", "Calibre setup failed",
    "Network", "Setup", "Status",
    "1. Connect to same WiFi", "2. In Calibre: Connect/share",
    "3. Start wireless device", "Keep this screen open",

    // WiFi Errors
    "Error: General failure", "Error: Network not found",
};
...
const char *const I18n::STRINGS_ZH[] = {
    ...
    "\xE6\x8F\x90\xE7\xA4\xBA: \xE5\x8F\xAF\xE9\x80\x9A\xE8\xBF\x87\xE7\x83\xAD\xE7\x82\xB9\xE5\x9C\xA8\xE6\x89\x8B\xE6\x9C\xBA\xE4\xB8\x8A\xE9\x85\x8D\xE7\xBD\xAEWiFi", // 提示: 可通过热点在手机上配置WiFi
    ...
    "\xE8\xAF\xB7\xE5\x9C\xA8\xE8\xAE\xBE\xE7\xBD\xAE\xE4\xB8\xAD\xE9\x85\x8D\xE7\xBD\xAEKOReader\xE8\xB4\xA6\xE6\x88\xB7", // 请在设置中配置KOReader账户
    ...
    // Calibre Connect UI
    "\xE8\xBF\x9E\xE6\x8E\xA5""Calibre", // 连接Calibre
    "Calibre\xE6\x97\xA0\xE7\xBA\xBF\xE4\xBC\xA0\xE4\xB9\xA6", // Calibre无线传书
    "\xE6\xAD\xA3\xE5\x9C\xA8\xE5\x90\xAF\xE5\x8A\xA8""Calibre...", // 正在启动Calibre...
    ...
    "1. \xE8\xBF\x9E\xE6\x8E\xA5\xE5\x88\xB0\xE7\x9B\xB8\xE5\x90\x8C""WiFi", // 1. 连接到相同WiFi
    "2. Calibre\xE4\xB8\xAD: \xE8\xBF\x9E\xE6\x8E\xA5/\xE5\x85\xB1\xE4\xBA\xAB", // 2. Calibre中: 连接/共享
    "3. \xE5\x90\xAF\xE5\x8A\xA8\xE6\x97\xA0\xE7\xBA\xBF\xE8\xAE\xBE\xE5\xA4\x87\xE8\xBF\x9E\xE6\x8E\xA5", // 3. 启动无线设备连接
...
const char *const I18n::STRINGS_JA[] = {
    ...
    "\xE3\x83\x92\xE3\x83\xB3\xE3\x83\x88: \xE3\x83\x9B\xE3\x83\x83\xE3\x83\x88\xE3\x82\xB9\xE3\x83\x9D\xE3\x83\x83\xE3\x83\x88\xE3\x81\xA7\xE3\x82\xB9\xE3\x83\x9E\xE3\x83\x9B\xE3\x81\x8B\xE3\x82\x89WiFi\xE8\xA8\xAD\xE5\xAE\x9A\xE5\x8F\xAF\xE8\x83\xBD", // ヒント: ホットスポットでスマホからWiFi設定可能
    ...
    "\xE8\xAA\x8D\xE8\xA8\xBC\xE6\x83\x85\xE5\xA0\xB1\xE3\x81\x8C\xE8\xA8\xAD\xE5\xAE\x9A\xE3\x81\x95\xE3\x82\x8C\xE3\x81\xA6\xE3\x81\x84\xE3\x81\xBE\xE3\x81\x9B\xE3\x82\x93", // 認証情報が設定されていません
    "\xE8\xA8\xAD\xE5\xAE\x9A\xE3\x81\xA7KOReader\xE3\x82\xA2\xE3\x82\xAB\xE3\x82\xA6\xE3\x83\xB3\xE3\x83\x88\xE3\x82\x92\xE8\xA8\xAD\xE5\xAE\x9A\xE3\x81\x97\xE3\x81\xA6\xE3\x81\x8F\xE3\x81\xA0\xE3\x81\x95\xE3\x81\x84", // 設定でKOReaderアカウントを設定してください
    "\xE9\x80\xB2\xE6\x8D\x97\xE3\x81\x8C\xE8\xA6\x8B\xE3\x81\xA4\xE3\x81\x8B\xE3\x82\x8A\xE3\x81\xBE\xE3\x81\x97\xE3\x81\x9F!", // 進捗が見つかりました!
    ...
    "\xE3\x83\xAD\xE3\x83\xBC\xE3\x82\xAB\xE3\x83\xAB\xE9\x80\xB2\xE6\x8D\x97\xE3\x82\x92\xE3\x82\xA2\xE3\x83\x83\xE3\x83\x97\xE3\x83\xAD\xE3\x83\xBC\xE3\x83\x89", // ローカル進捗をアップロード
    "\xE3\x83\xAA\xE3\x83\xA2\xE3\x83\xBC\xE3\x83\x88\xE9\x80\xB2\xE6\x8D\x97\xE3\x81\x8C\xE8\xA6\x8B\xE3\x81\xA4\xE3\x81\x8B\xE3\x82\x8A\xE3\x81\xBE\xE3\x81\x9B\xE3\x82\x93", // リモート進捗が見つかりません
    "\xE7\x8F\xBE\xE5\x9C\xA8\xE3\x81\xAE\xE4\xBD\x8D\xE7\xBD\xAE\xE3\x82\x92\xE3\x82\xA2\xE3\x83\x83\xE3\x83\x97\xE3\x83\xAD\xE3\x83\xBC\xE3\x83\x89\xE3\x81\x97\xE3\x81\xBE\xE3\x81\x99\xE3\x81\x8B?", // 現在の位置をアップロードしますか?
    "\xE9\x80\xB2\xE6\x8D\x97\xE3\x82\x92\xE3\x82\xA2\xE3\x83\x83\xE3\x83\x97\xE3\x83\xAD\xE3\x83\xBC\xE3\x83\x89\xE3\x81\x97\xE3\x81\xBE\xE3\x81\x97\xE3\x81\x9F!", // 進捗をアップロードしました!
    ...
    "\xE6\x9B\xB8\xE7\xB1\x8D\xE3\x81\xAE\xE5\x9F\x8B\xE3\x82\x81\xE8\xBE\xBC\xE3\x81\xBF\xE3\x82\xB9\xE3\x82\xBF\xE3\x82\xA4\xE3\x83\xAB", // 書籍の埋め込みスタイル
    "\xE3\x83\x95\xE3\x83\xAD\xE3\x83\xB3\xE3\x83\x88\xE3\x83\x9C\xE3\x82\xBF\xE3\x83\xB3\xE3\x83\xAA\xE3\x83\x9E\xE3\x83\x83\xE3\x83\x97", // フロントボタンリマップ
    // Additional Setting Values (v1.0 merge)
    ...
    "\xE3\x83\x95\xE3\x83\xAB\xEF\xBC\x88\xE3\x83\x91\xE3\x83\xBC\xE3\x82\xBB\xE3\x83\xB3\xE3\x83\x88\xE4\xBB\x98\xE3\x81\x8D\xEF\xBC\x89", // フル（パーセント付き）
    "\xE3\x83\x95\xE3\x83\xAB\xEF\xBC\x88\xE3\x83\x96\xE3\x83\x83\xE3\x82\xAF\xE3\x83\x90\xE3\x83\xBC\xE4\xBB\x98\xE3\x81\x8D\xEF\xBC\x89", // フル（ブックバー付き）
    "\xE3\x83\x96\xE3\x83\x83\xE3\x82\xAF\xE3\x83\x90\xE3\x83\xBC\xE3\x81\xAE\xE3\x81\xBF", // ブックバーのみ
    "\xE3\x83\x95\xE3\x83\xAB\xEF\xBC\x88\xE3\x83\x81\xE3\x83\xA3\xE3\x83\x97\xE3\x82\xBF\xE3\x83\xBC\xE3\x83\x90\xE3\x83\xBC\xE4\xBB\x98\xE3\x81\x8D\xEF\xBC\x89", // フル（チャプターバー付き）
    ...
    "\xE6\x9B\xB8\xE7\xB1\x8D\xE3\x82\xAD\xE3\x83\xA3\xE3\x83\x83\xE3\x82\xB7\xE3\x83\xA5\xE3\x82\x92\xE5\x89\x8A\xE9\x99\xA4", // 書籍キャッシュを削除
    ...
    "\xE3\x83\x89\xE3\x82\xAD\xE3\x83\xA5\xE3\x83\xA1\xE3\x83\xB3\xE3\x83\x88\xE3\x83\x8F\xE3\x83\x83\xE3\x82\xB7\xE3\x83\xA5\xE8\xA8\x88\xE7\xAE\x97\xE4\xB8\xAD...", // ドキュメントハッシュ計算中...
    "\xE3\x83\x89\xE3\x82\xAD\xE3\x83\xA5\xE3\x83\xA1\xE3\x83\xB3\xE3\x83\x88\xE3\x83\x8F\xE3\x83\x83\xE3\x82\xB7\xE3\x83\xA5\xE3\x81\xAE\xE8\xA8\x88\xE7\xAE\x97\xE3\x81\xAB\xE5\xA4\xB1\xE6\x95\x97", // ドキュメントハッシュの計算に失敗
    "\xE3\x83\xAA\xE3\x83\xA2\xE3\x83\xBC\xE3\x83\x88\xE9\x80\xB2\xE6\x8D\x97\xE3\x82\x92\xE5\x8F\x96\xE5\xBE\x97\xE4\xB8\xAD...", // リモート進捗を取得中...
    "\xE9\x80\xB2\xE6\x8D\x97\xE3\x82\x92\xE3\x82\xA2\xE3\x83\x83\xE3\x83\x97\xE3\x83\xAD\xE3\x83\xBC\xE3\x83\x89\xE4\xB8\xAD...", // 進捗をアップロード中...
    ...
    "Calibre\xE3\x81\xAE\xE3\x82\xBB\xE3\x83\x83\xE3\x83\x88\xE3\x82\xA2\xE3\x83\x83\xE3\x83\x97\xE3\x81\xAB\xE5\xA4\xB1\xE6\x95\x97", // Calibreのセットアップに失敗
    ...
    "3. \xE3\x83\xAF\xE3\x82\xA4\xE3\x83\xA4\xE3\x83\xAC\xE3\x82\xB9\xE3\x83\x87\xE3\x83\x90\xE3\x82\xA4\xE3\x82\xB9\xE3\x82\x92\xE9\x96\x8B\xE5\xA7\x8B", // 3. ワイヤレスデバイスを開始
    "\xE3\x81\x93\xE3\x81\xAE\xE7\x94\xBB\xE9\x9D\xA2\xE3\x82\x92\xE9\x96\x8B\xE3\x81\x84\xE3\x81\x9F\xE3\x81\xBE\xE3\x81\xBE", // この画面を開いたまま

    // WiFi Errors
    "\xE3\x82\xA8\xE3\x83\xA9\xE3\x83\xBC: \xE6\x8E\xA5\xE7\xB6\x9A\xE5\xA4\xB1\xE6\x95\x97", // エラー: 接続失敗
    "\xE3\x82\xA8\xE3\x83\xA9\xE3\x83\xBC: \xE3\x83\x8D\xE3\x83\x83\xE3\x83\x88\xE3\x83\xAF\xE3\x83\xBC\xE3\x82\xAF\xE3\x81\x8C\xE8\xA6\x8B\xE3\x81\xA4\xE3\x81\x8B\xE3\x82\x8A\xE3\x81\xBE\xE3\x81\x9B\xE3\x82\x93", // エラー: ネットワークが見つかりません
};
