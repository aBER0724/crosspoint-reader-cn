...
void EpubReaderPercentSelectionActivity::renderScreen() {
  ...
  renderer.drawCenteredText(UI_12_FONT_ID, 15, TR(GO_TO_POSITION), true, EpdFontFamily::BOLD);
  ...
  renderer.drawCenteredText(SMALL_FONT_ID, barY + 30, TR(PERCENT_STEP_HINT), true);
